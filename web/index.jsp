...
<html>
        ...
        <body>
                ...
                <div class="layui-bg-white" align="center"><a href="QuestionAction?method=get&questionId=${sessionScope.question.questionId}"><p style="font-size: 36px; color: black">当前题目: No.${sessionScope.question.questionId} <c:if test="${isCanShow}">${sessionScope.question.title}</c:if></p></a></div>
