...
<html>
        ...
        <body>
                ...
                <c:if test="${empty contest}">
                    ...
                    <c:redirect url="ContestAction?method=getAllList&contestPage=1&contestLimit=10" />
                </c:if>
                                                    ...
                                                    <table class="layui-table" lay-even lay-skin="nob">
                                                            ...
                                                            <tbody>
                                                                    <c:forEach items="${CQMap[contest.contestId]}" var="q" varStatus="status">
                                                                        <tr>
                                                                                <td>No.${status.index + 1} <c:if test="${isCanShow}">${questionMap[q].title}</c:if></td>
                                                    ...
                                                    <table class="layui-table" lay-even lay-skin="nob">
                                                            ...
                                                            <tbody>
                                                                    <c:forEach items="${contestRank}" var="c" varStatus="status">
                                                                        ...
                                                                        <tr>
                                                                                <td>
                                                                                        ${status.index + (contextPage - 1) * contextLimit + 1}
                                                                                </td>
                                                                                <td>
