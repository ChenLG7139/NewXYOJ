...
<html>
        <head>
                ...
                <script>
                    function addExample() {
                        ...
                        str = str.replace("input_demo", "input_" + index);
                        str = str.replace("output_demo", "output_" + index);
        ...
        <body>
                ...
                <div class="fly-panel" id="left" style="float: left; width: 675px; border: 1px solid gray;">
                        <form class="layui-form"  id="left_form" action="${pageContext.request.contextPath}/QuestionAction?method=update&questionId=${question.questionId}" method="POST">
                                <div class="layui-form-item">
                                        <label class="layui-form-label">题目标题</label>
                                        <div class="layui-input-block">
                                                <input type="text" name="title" required  lay-verify="required" placeholder="请输入标题" autocomplete="off" value="${question.title}" class="layui-input">
                                        </div>
                                </div>
                                <div class="layui-form-item">
                                        <label class="layui-form-label">分值</label>
                                        <div class="layui-input-block">
                                                <input type="radio" name="score" value="1" title="1" <c:if test="${question.score == '1'}">checked</c:if>>
                                                <input type="radio" name="score" value="2" title="2" <c:if test="${question.score == '2'}">checked</c:if>>
                                                <input type="radio" name="score" value="3" title="3" <c:if test="${question.score == '3'}">checked</c:if>>
                                                <input type="radio" name="score" value="4" title="4" <c:if test="${question.score == '4'}">checked</c:if>>
                                                <input type="radio" name="score" value="5" title="5" <c:if test="${question.score == '5'}">checked</c:if>>
                                                </div>
                                        </div>
                                        <div class="layui-form-item layui-form-text">
                                                <label class="layui-form-label">题目要求</label>
                                                <div class="layui-input-block">
                                                        <textarea name="body" required lay-verify="required" placeholder="请输入内容"  class="layui-textarea fly-editor" style="height: 150px;">${question.body}</textarea>
                                        </div>
                                </div>
                                <div class="layui-form-item">
                                ...
                                <span id="setTime">
                                        ...
                                        <div class="layui-form-item">
                                                ...
                                                <div class="layui-input-block">
                                                        <input type="text" id="startTime" name="startTime" value="${question.startTime}" class="layui-input">
                                                </div>
                                        </div>
                                        <div class="layui-form-item">
                                                <label class="layui-form-label">结束时间</label>
                                                <div class="layui-input-block">
                                                        <input type="text" id="endTime" name="endTime" value="${question.endTime}" class="layui-input">
                                                </div>
                                        </div>
                                </span>
                                <div class="layui-form-item layui-form-text">
                                        ...
                                        <div class="layui-input-block">
                                                <textarea name="inputFormat" required lay-verify="required" placeholder="请输入内容"  class="layui-textarea fly-editor" style="height: 150px;">${question.inputFormat}</textarea> 
                                        </div>
                                </div>
                                <div class="layui-form-item layui-form-text">
                                        <label class="layui-form-label">输出格式</label>
                                        <div class="layui-input-block">
                                                <textarea name="outputFormat" required lay-verify="required" placeholder="请输入内容"  class="layui-textarea fly-editor" style="height: 150px;">${question.outputFormat}</textarea>
                                        </div>
                                </div>
                                <div class="layui-form-item layui-form-text">
                                        <label class="layui-form-label">输入样例</label>
                                        <div class="layui-input-block">
                                                <textarea name="inputTest" required lay-verify="required" placeholder="请输入内容"  class="layui-textarea fly-editor" style="height: 150px;">${question.inputTest}</textarea>
                                        </div>
                                </div>
                                <div class="layui-form-item layui-form-text">
                                        <label class="layui-form-label">输出样例</label>
                                        <div class="layui-input-block">
                                                <textarea name="outputTest" required lay-verify="required" placeholder="请输入内容"  class="layui-textarea fly-editor" style="height: 150px;">${question.outputFormat}</textarea>
                                        </div>
                                </div>
                                <input type="text" id="number" name="number" value="${questionCheckersSize}" class="layui-input">
                                <div class="layui-form-item">
                                        ...
                                        <div class="layui-form-item layui-form-text">
                                                <fieldset class="layui-elem-field layui-field-title">
                                                        ...
                                                        <div class="layui-block">
                                                                ...
                                                                <div class="layui-input-block">
                                                                        <textarea name="input_demo" placeholder="请输入内容" class="layui-textarea"></textarea>
                                                                </div>
                                                        </div>
                                                        <div class="layui-block">
                                                                <label class="layui-form-label">输出</label>
                                                                <div class="layui-input-block">
                                                                        <textarea name="output_demo" placeholder="请输入内容" class="layui-textarea"></textarea>
                                                                </div>
                                                        </div>
                                                </fieldset>
                                        </div>
                                </div>
                                <c:forEach items="${questionCheckers}" var="c" varStatus="status">
                                    <div class="layui-form-item layui-form-text">
                                            <fieldset class="layui-elem-field layui-field-title">
                                                    <legend>第${status.index + 1}组
                                                    </legend>
                                                    <div class="layui-block">
                                                            <label class="layui-form-label">输入</label>
                                                            <div class="layui-input-block">
                                                                    <textarea name="input_${status.index}" placeholder="请输入内容" class="layui-textarea">${c.input}</textarea>
                                                            </div>
                                                    </div>
                                                    <div class="layui-block">
                                                            <label class="layui-form-label">输出</label>
                                                            <div class="layui-input-block">
                                                                    <textarea name="output_${status.index}" placeholder="请输入内容" class="layui-textarea">${c.output}</textarea>
                                                            </div>
                                                    </div>
                                            </fieldset>
                                    </div>
