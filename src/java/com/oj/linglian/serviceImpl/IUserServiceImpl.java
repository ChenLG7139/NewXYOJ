...
public class IUserServiceImpl implements IUserService {
    ...
    public int updateOfSigns(User user, String signs) {
        return dao.updateOfSigns(user, signs);
    }
    public int updateOfIp(User user, String ip) {
        return dao.updateOfIp(user, ip);
    }
    ...
    public int updateOfUserIdAndSigns(User user, String userId, String signs) {
        return dao.updateOfUserIdAndSigns(user, userId, signs);
    }
    public int updateOfUserIdAndIp(User user, String userId, String ip) {
        return dao.updateOfUserIdAndIp(user, userId, ip);
    }
    ...
    public int updateOfPasswordAndSigns(User user, String password, String signs) {
        return dao.updateOfPasswordAndSigns(user, password, signs);
    }
    public int updateOfPasswordAndIp(User user, String password, String ip) {
        return dao.updateOfPasswordAndIp(user, password, ip);
    }
    ...
    public int updateOfEmailAndSigns(User user, String email, String signs) {
        return dao.updateOfEmailAndSigns(user, email, signs);
    }
    public int updateOfEmailAndIp(User user, String email, String ip) {
        return dao.updateOfEmailAndIp(user, email, ip);
    }
    ...
    public int updateOfPhoneAndSigns(User user, String phone, String signs) {
        return dao.updateOfPhoneAndSigns(user, phone, signs);
    }
    public int updateOfPhoneAndIp(User user, String phone, String ip) {
        return dao.updateOfPhoneAndIp(user, phone, ip);
    }
    ...
    public int updateOfSexAndSigns(User user, String sex, String signs) {
        return dao.updateOfSexAndSigns(user, sex, signs);
    }
    public int updateOfSexAndIp(User user, String sex, String ip) {
        return dao.updateOfSexAndIp(user, sex, ip);
    }
    ...
    public int updateOfPassQuestionsAndSigns(User user, String passQuestions, String signs) {
        return dao.updateOfPassQuestionsAndSigns(user, passQuestions, signs);
    }
    public int updateOfPassQuestionsAndIp(User user, String passQuestions, String ip) {
        return dao.updateOfPassQuestionsAndIp(user, passQuestions, ip);
    }
    ...
    public int updateOfScoreAndSigns(User user, String score, String signs) {
        return dao.updateOfScoreAndSigns(user, score, signs);
    }
    public int updateOfScoreAndIp(User user, String score, String ip) {
        return dao.updateOfScoreAndIp(user, score, ip);
    }
    ...
    public int updateOfLastCodeAndSigns(User user, String lastCode, String signs) {
        return dao.updateOfLastCodeAndSigns(user, lastCode, signs);
    }
    public int updateOfLastCodeAndIp(User user, String lastCode, String ip) {
        return dao.updateOfLastCodeAndIp(user, lastCode, ip);
    }
    ...
    public int updateOfLastQuestionIdAndSigns(User user, String lastQuestionId, String signs) {
        return dao.updateOfLastQuestionIdAndSigns(user, lastQuestionId, signs);
    }
    public int updateOfLastQuestionIdAndIp(User user, String lastQuestionId, String ip) {
        return dao.updateOfLastQuestionIdAndIp(user, lastQuestionId, ip);
    }
    ...
    public int updateOfLvlAndSigns(User user, String lvl, String signs) {
        return dao.updateOfLvlAndSigns(user, lvl, signs);
    }
    public int updateOfLvlAndIp(User user, String lvl, String ip) {
        return dao.updateOfLvlAndIp(user, lvl, ip);
    }
    ...
    public int updateOfParamAndSigns(User user, String param, String signs) {
        return dao.updateOfParamAndSigns(user, param, signs);
    }
    public int updateOfParamAndIp(User user, String param, String ip) {
        return dao.updateOfParamAndIp(user, param, ip);
    }
    ...
    public int updateOfNameAndSigns(User user, String name, String signs) {
        return dao.updateOfNameAndSigns(user, name, signs);
    }
    public int updateOfNameAndIp(User user, String name, String ip) {
        return dao.updateOfNameAndIp(user, name, ip);
    }
    public int updateOfLastLoginAndSigns(User user, String lastLogin, String signs) {
        return dao.updateOfLastLoginAndSigns(user, lastLogin, signs);
    }
    public int updateOfLastLoginAndIp(User user, String lastLogin, String ip) {
        return dao.updateOfLastLoginAndIp(user, lastLogin, ip);
    }
    public int updateOfSignsAndIp(User user, String signs, String ip) {
        return dao.updateOfSignsAndIp(user, signs, ip);
    }
    ...
    public int removeOfSigns(String signs) {
        return dao.removeOfSigns(signs);
    }
    ...
    public int removeOfUserIdAndSigns(String userId, String signs) {
        return dao.removeOfUserIdAndSigns(userId, signs);
    }
    ...
    public int removeOfPasswordAndSigns(String password, String signs) {
        return dao.removeOfPasswordAndSigns(password, signs);
    }
    public int removeOfPasswordAndIp(String password, String ip) {
        return dao.removeOfPasswordAndIp(password, ip);
    }
    ...
    public int removeOfEmailAndSigns(String email, String signs) {
        return dao.removeOfEmailAndSigns(email, signs);
    }
    public int removeOfEmailAndIp(String email, String ip) {
        return dao.removeOfEmailAndIp(email, ip);
    }
    ...
    public int removeOfPhoneAndSigns(String phone, String signs) {
        return dao.removeOfPhoneAndSigns(phone, signs);
    }
    public int removeOfPhoneAndIp(String phone, String ip) {
        return dao.removeOfPhoneAndIp(phone, ip);
    }
    ...
    public int removeOfSexAndSigns(String sex, String signs) {
        return dao.removeOfSexAndSigns(sex, signs);
    }
    public int removeOfSexAndIp(String sex, String ip) {
        return dao.removeOfSexAndIp(sex, ip);
    }
    ...
    public int removeOfPassQuestionsAndSigns(String passQuestions, String signs) {
        return dao.removeOfPassQuestionsAndSigns(passQuestions, signs);
    }
    public int removeOfPassQuestionsAndIp(String passQuestions, String ip) {
        return dao.removeOfPassQuestionsAndIp(passQuestions, ip);
    }
    ...
    public int removeOfScoreAndSigns(String score, String signs) {
        return dao.removeOfScoreAndSigns(score, signs);
    }
    public int removeOfScoreAndIp(String score, String ip) {
        return dao.removeOfScoreAndIp(score, ip);
    }
    ...
    public int removeOfLastCodeAndSigns(String lastCode, String signs) {
        return dao.removeOfLastCodeAndSigns(lastCode, signs);
    }
    public int removeOfLastCodeAndIp(String lastCode, String ip) {
        return dao.removeOfLastCodeAndIp(lastCode, ip);
    }
    ...
    public int removeOfLastQuestionIdAndSigns(String lastQuestionId, String signs) {
        return dao.removeOfLastQuestionIdAndSigns(lastQuestionId, signs);
    }
    public int removeOfLastQuestionIdAndIp(String lastQuestionId, String ip) {
        return dao.removeOfLastQuestionIdAndIp(lastQuestionId, ip);
    }
    ...
    public int removeOfLvlAndSigns(String lvl, String signs) {
        return dao.removeOfLvlAndSigns(lvl, signs);
    }
    public int removeOfLvlAndIp(String lvl, String ip) {
        return dao.removeOfLvlAndIp(lvl, ip);
    }
    ...
    public int removeOfParamAndSigns(String param, String signs) {
        return dao.removeOfParamAndSigns(param, signs);
    }
    public int removeOfParamAndIp(String param, String ip) {
        return dao.removeOfParamAndIp(param, ip);
    }
    public int removeOfNameAndLastLogin(String name, String lastLogin) {
        return dao.removeOfNameAndLastLogin(name, lastLogin);
    }
    public int removeOfNameAndSigns(String name, String signs) {
        return dao.removeOfNameAndSigns(name, signs);
    }
    public int removeOfNameAndIp(String name, String ip) {
        return dao.removeOfNameAndIp(name, ip);
    }
    public int removeOfLastLoginAndSigns(String lastLogin, String signs) {
        return dao.removeOfLastLoginAndSigns(lastLogin, signs);
    }
    public int removeOfLastLoginAndIp(String lastLogin, String ip) {
        return dao.removeOfLastLoginAndIp(lastLogin, ip);
    }
    public int removeOfSignsAndIp(String signs, String ip) {
        return dao.removeOfSignsAndIp(signs, ip);
    }
    ...
    public int insertOfSigns(String signs) {
        return dao.insertOfSigns(signs);
    }
    ...
    public int insertOfUserIdAndSigns(String userId, String signs) {
        return dao.insertOfUserIdAndSigns(userId, signs);
    }
    ...
    public int insertOfPasswordAndSigns(String password, String signs) {
        return dao.insertOfPasswordAndSigns(password, signs);
    }
    public int insertOfPasswordAndIp(String password, String ip) {
        return dao.insertOfPasswordAndIp(password, ip);
    }
    ...
    public int insertOfEmailAndSigns(String email, String signs) {
        return dao.insertOfEmailAndSigns(email, signs);
    }
    public int insertOfEmailAndIp(String email, String ip) {
        return dao.insertOfEmailAndIp(email, ip);
    }
    ...
    public int insertOfPhoneAndSigns(String phone, String signs) {
        return dao.insertOfPhoneAndSigns(phone, signs);
    }
    public int insertOfPhoneAndIp(String phone, String ip) {
        return dao.insertOfPhoneAndIp(phone, ip);
    }
    ...
    public int insertOfSexAndSigns(String sex, String signs) {
        return dao.insertOfSexAndSigns(sex, signs);
    }
    public int insertOfSexAndIp(String sex, String ip) {
        return dao.insertOfSexAndIp(sex, ip);
    }
    ...
    public int insertOfPassQuestionsAndSigns(String passQuestions, String signs) {
        return dao.insertOfPassQuestionsAndSigns(passQuestions, signs);
    }
    public int insertOfPassQuestionsAndIp(String passQuestions, String ip) {
        return dao.insertOfPassQuestionsAndIp(passQuestions, ip);
    }
    ...
    public int insertOfScoreAndSigns(String score, String signs) {
        return dao.insertOfScoreAndSigns(score, signs);
    }
    public int insertOfScoreAndIp(String score, String ip) {
        return dao.insertOfScoreAndIp(score, ip);
    }
    ...
    public int insertOfLastCodeAndSigns(String lastCode, String signs) {
        return dao.insertOfLastCodeAndSigns(lastCode, signs);
    }
    public int insertOfLastCodeAndIp(String lastCode, String ip) {
        return dao.insertOfLastCodeAndIp(lastCode, ip);
    }
    ...
    public int insertOfLastQuestionIdAndSigns(String lastQuestionId, String signs) {
        return dao.insertOfLastQuestionIdAndSigns(lastQuestionId, signs);
    }
    public int insertOfLastQuestionIdAndIp(String lastQuestionId, String ip) {
        return dao.insertOfLastQuestionIdAndIp(lastQuestionId, ip);
    }
    ...
    public int insertOfLvlAndSigns(String lvl, String signs) {
        return dao.insertOfLvlAndSigns(lvl, signs);
    }
    public int insertOfLvlAndIp(String lvl, String ip) {
        return dao.insertOfLvlAndIp(lvl, ip);
    }
    ...
    public int insertOfParamAndSigns(String param, String signs) {
        return dao.insertOfParamAndSigns(param, signs);
    }
    public int insertOfParamAndIp(String param, String ip) {
        return dao.insertOfParamAndIp(param, ip);
    }
    public int insertOfNameAndLastLogin(String name, String lastLogin) {
        return dao.insertOfNameAndLastLogin(name, lastLogin);
    }
    public int insertOfNameAndSigns(String name, String signs) {
        return dao.insertOfNameAndSigns(name, signs);
    }
    public int insertOfNameAndIp(String name, String ip) {
        return dao.insertOfNameAndIp(name, ip);
    }
    public int insertOfLastLoginAndSigns(String lastLogin, String signs) {
        return dao.insertOfLastLoginAndSigns(lastLogin, signs);
    }
    public int insertOfLastLoginAndIp(String lastLogin, String ip) {
        return dao.insertOfLastLoginAndIp(lastLogin, ip);
    }
    public int insertOfSignsAndIp(String signs, String ip) {
        return dao.insertOfSignsAndIp(signs, ip);
    }
    ...
    public User getUserOfSigns(String signs) {
        return dao.getUserOfSigns(signs);
    }
    public User getUserOfIp(String ip) {
        return dao.getUserOfIp(ip);
    }
    ...
    public User getUserOfUserIdAndSigns(String userId, String signs) {
        return dao.getUserOfUserIdAndSigns(userId, signs);
    }
    public User getUserOfUserIdAndIp(String userId, String ip) {
        return dao.getUserOfUserIdAndIp(userId, ip);
    }
    ...
    public User getUserOfPasswordAndSigns(String password, String signs) {
        return dao.getUserOfPasswordAndSigns(password, signs);
    }
    public User getUserOfPasswordAndIp(String password, String ip) {
        return dao.getUserOfPasswordAndIp(password, ip);
    }
    ...
    public User getUserOfEmailAndSigns(String email, String signs) {
        return dao.getUserOfEmailAndSigns(email, signs);
    }
    public User getUserOfEmailAndIp(String email, String ip) {
        return dao.getUserOfEmailAndIp(email, ip);
    }
    ...
    public User getUserOfPhoneAndSigns(String phone, String signs) {
        return dao.getUserOfPhoneAndSigns(phone, signs);
    }
    public User getUserOfPhoneAndIp(String phone, String ip) {
        return dao.getUserOfPhoneAndIp(phone, ip);
    }
    ...
    public User getUserOfSexAndSigns(String sex, String signs) {
        return dao.getUserOfSexAndSigns(sex, signs);
    }
    public User getUserOfSexAndIp(String sex, String ip) {
        return dao.getUserOfSexAndIp(sex, ip);
    }
    ...
    public User getUserOfPassQuestionsAndSigns(String passQuestions, String signs) {
        return dao.getUserOfPassQuestionsAndSigns(passQuestions, signs);
    }
    public User getUserOfPassQuestionsAndIp(String passQuestions, String ip) {
        return dao.getUserOfPassQuestionsAndIp(passQuestions, ip);
    }
    ...
    public User getUserOfScoreAndSigns(String score, String signs) {
        return dao.getUserOfScoreAndSigns(score, signs);
    }
    public User getUserOfScoreAndIp(String score, String ip) {
        return dao.getUserOfScoreAndIp(score, ip);
    }
    ...
    public User getUserOfLastCodeAndSigns(String lastCode, String signs) {
        return dao.getUserOfLastCodeAndSigns(lastCode, signs);
    }
    public User getUserOfLastCodeAndIp(String lastCode, String ip) {
        return dao.getUserOfLastCodeAndIp(lastCode, ip);
    }
    ...
    public User getUserOfLastQuestionIdAndSigns(String lastQuestionId, String signs) {
        return dao.getUserOfLastQuestionIdAndSigns(lastQuestionId, signs);
    }
    public User getUserOfLastQuestionIdAndIp(String lastQuestionId, String ip) {
        return dao.getUserOfLastQuestionIdAndIp(lastQuestionId, ip);
    }
    ...
    public User getUserOfLvlAndSigns(String lvl, String signs) {
        return dao.getUserOfLvlAndSigns(lvl, signs);
    }
    public User getUserOfLvlAndIp(String lvl, String ip) {
        return dao.getUserOfLvlAndIp(lvl, ip);
    }
    ...
    public User getUserOfParamAndSigns(String param, String signs) {
        return dao.getUserOfParamAndSigns(param, signs);
    }
    public User getUserOfParamAndIp(String param, String ip) {
        return dao.getUserOfParamAndIp(param, ip);
    }
    public User getUserOfNameAndLastLogin(String name, String lastLogin) {
        return dao.getUserOfNameAndLastLogin(name, lastLogin);
    }
    public User getUserOfNameAndSigns(String name, String signs) {
        return dao.getUserOfNameAndSigns(name, signs);
    }
    public User getUserOfNameAndIp(String name, String ip) {
        return dao.getUserOfNameAndIp(name, ip);
    }
    public User getUserOfLastLoginAndSigns(String lastLogin, String signs) {
        return dao.getUserOfLastLoginAndSigns(lastLogin, signs);
    }
    public User getUserOfLastLoginAndIp(String lastLogin, String ip) {
        return dao.getUserOfLastLoginAndIp(lastLogin, ip);
    }
    public User getUserOfSignsAndIp(String signs, String ip) {
        return dao.getUserOfSignsAndIp(signs, ip);
    }
    ...
    public List<User> getUsersOfSigns(String signs) {
        return dao.getUsersOfSigns(signs);
    }
    public List<User> getUsersOfIp(String ip) {
        return dao.getUsersOfIp(ip);
    }
    ...
    public List<User> getUsersOfUserIdAndSigns(String userId, String signs) {
        return dao.getUsersOfUserIdAndSigns(userId, signs);
    }
    public List<User> getUsersOfUserIdAndIp(String userId, String ip) {
        return dao.getUsersOfUserIdAndIp(userId, ip);
    }
    ...
    public List<User> getUsersOfPasswordAndSigns(String password, String signs) {
        return dao.getUsersOfPasswordAndSigns(password, signs);
    }
    public List<User> getUsersOfPasswordAndIp(String password, String ip) {
        return dao.getUsersOfPasswordAndIp(password, ip);
    }
    ...
    public List<User> getUsersOfEmailAndSigns(String email, String signs) {
        return dao.getUsersOfEmailAndSigns(email, signs);
    }
    public List<User> getUsersOfEmailAndIp(String email, String ip) {
        return dao.getUsersOfEmailAndIp(email, ip);
    }
    ...
    public List<User> getUsersOfPhoneAndSigns(String phone, String signs) {
        return dao.getUsersOfPhoneAndSigns(phone, signs);
    }
    public List<User> getUsersOfPhoneAndIp(String phone, String ip) {
        return dao.getUsersOfPhoneAndIp(phone, ip);
    }
    ...
    public List<User> getUsersOfSexAndSigns(String sex, String signs) {
        return dao.getUsersOfSexAndSigns(sex, signs);
    }
    public List<User> getUsersOfSexAndIp(String sex, String ip) {
        return dao.getUsersOfSexAndIp(sex, ip);
    }
    ...
    public List<User> getUsersOfPassQuestionsAndSigns(String passQuestions, String signs) {
        return dao.getUsersOfPassQuestionsAndSigns(passQuestions, signs);
    }
    public List<User> getUsersOfPassQuestionsAndIp(String passQuestions, String ip) {
        return dao.getUsersOfPassQuestionsAndIp(passQuestions, ip);
    }
    ...
    public List<User> getUsersOfScoreAndSigns(String score, String signs) {
        return dao.getUsersOfScoreAndSigns(score, signs);
    }
    public List<User> getUsersOfScoreAndIp(String score, String ip) {
        return dao.getUsersOfScoreAndIp(score, ip);
    }
    ...
    public List<User> getUsersOfLastCodeAndSigns(String lastCode, String signs) {
        return dao.getUsersOfLastCodeAndSigns(lastCode, signs);
    }
    public List<User> getUsersOfLastCodeAndIp(String lastCode, String ip) {
        return dao.getUsersOfLastCodeAndIp(lastCode, ip);
    }
    ...
    public List<User> getUsersOfLastQuestionIdAndSigns(String lastQuestionId, String signs) {
        return dao.getUsersOfLastQuestionIdAndSigns(lastQuestionId, signs);
    }
    public List<User> getUsersOfLastQuestionIdAndIp(String lastQuestionId, String ip) {
        return dao.getUsersOfLastQuestionIdAndIp(lastQuestionId, ip);
    }
    ...
    public List<User> getUsersOfLvlAndSigns(String lvl, String signs) {
        return dao.getUsersOfLvlAndSigns(lvl, signs);
    }
    public List<User> getUsersOfLvlAndIp(String lvl, String ip) {
        return dao.getUsersOfLvlAndIp(lvl, ip);
    }
    ...
    public List<User> getUsersOfParamAndSigns(String param, String signs) {
        return dao.getUsersOfParamAndSigns(param, signs);
    }
    public List<User> getUsersOfParamAndIp(String param, String ip) {
        return dao.getUsersOfParamAndIp(param, ip);
    }
    ...
    public List<User> getUsersOfNameAndSigns(String name, String signs) {
        return dao.getUsersOfNameAndSigns(name, signs);
    }
    public List<User> getUsersOfNameAndIp(String name, String ip) {
        return dao.getUsersOfNameAndIp(name, ip);
    }
    public List<User> getUsersOfLastLoginAndSigns(String lastLogin, String signs) {
        return dao.getUsersOfLastLoginAndSigns(lastLogin, signs);
    }
    public List<User> getUsersOfLastLoginAndIp(String lastLogin, String ip) {
        return dao.getUsersOfLastLoginAndIp(lastLogin, ip);
    }
    public List<User> getUsersOfSignsAndIp(String signs, String ip) {
        return dao.getUsersOfSignsAndIp(signs, ip);
    }
}
