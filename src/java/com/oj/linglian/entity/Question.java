...
public class Question {
    ...
    public String toString() {
        return "Question [questionId=" + questionId + ", title=" + title + ", body=" + body + ", score=" + score + ", demoCode=" + demoCode + ", rightPeople=" + rightPeople + ", mainPeople=" + mainPeople + ", startTime=" + startTime + ", endTime=" + endTime + ", inputFormat=" + inputFormat + ", outputFormat=" + outputFormat + ", inputTest=" + inputTest + ", outputTest=" + outputTest + ", contestId=" + contestId + ", userId=" + userId + ", demoBody=" + demoBody + ", ]";
    }
